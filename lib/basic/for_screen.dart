...
// dart 이라는 언어는 java + javaScript + c++ 에서 유용하다 판단되는 예약어와
// 기능을 조합한 언어
      ...
      body: SingleChildScrollView(child: Center(
        child: Column(
          ...
          children: [
            ...
            for(int i = 0; i < 5; i++)
              // java 에서는 for문에 관련된 출력을 System.out.println() 출력문을 확인했지만
            ...
            // hr = Divider  height = 상위 클래스와 얼만큼 높이 차이가 있는가 간격
            ...
            // controller 에서 List<Product> 데이터를 전달받았음. DB 에 있는 모든 상품들
            // map 대신 사용하는 방법
            //
